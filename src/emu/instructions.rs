...
mod lookup {
    ...
    lazy_static! {
        pub static ref INSTRUCTIONS: [Instruction; 256] = [
            ...
            I::new(IT::Bne, A::Rel, 2),I::new(IT::Cmp, A::Izy, 5),I::new(IT::Xxx, A::Imp, 2),I::new(IT::Xxx, A::Imp, 8),I::new(IT::Nop, A::Zpx, 4),I::new(IT::Cmp, A::Zpx, 4),I::new(IT::Dec, A::Zpx, 6),I::new(IT::Xxx, A::Imp, 6),I::new(IT::Cld, A::Imp, 2),I::new(IT::Cmp, A::Aby, 4),I::new(IT::Nop, A::Imp, 2),I::new(IT::Xxx, A::Imp, 7),I::new(IT::Nop, A::Abx, 4),I::new(IT::Cmp, A::Abx, 4),I::new(IT::Dec, A::Abx, 7),I::new(IT::Xxx, A::Imp, 7),
            ...
            I::new(IT::Beq, A::Rel, 2),I::new(IT::Sbc, A::Izy, 5),I::new(IT::Xxx, A::Imp, 2),I::new(IT::Xxx, A::Imp, 8),I::new(IT::Nop, A::Zpx, 4),I::new(IT::Sbc, A::Zpx, 4),I::new(IT::Inc, A::Zpx, 6),I::new(IT::Xxx, A::Imp, 6),I::new(IT::Sed, A::Imp, 2),I::new(IT::Sbc, A::Aby, 4),I::new(IT::Nop, A::Imp, 2),I::new(IT::Xxx, A::Imp, 7),I::new(IT::Nop, A::Abx, 4),I::new(IT::Sbc, A::Abx, 4),I::new(IT::Inc, A::Abx, 7),I::new(IT::Xxx, A::Imp, 7),
        ];
    }
}
